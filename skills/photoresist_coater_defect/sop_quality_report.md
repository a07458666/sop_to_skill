...
| --- | --- | --- | --- | --- | --- |
| `confirm_defect_signal` | API | - | 2 | 2 | ✅ 通過 |
| `hold_affected_tool_and_lots` | API | - | 3 | 2 | ✅ 通過 |
| `review_coater_process_data` | API | - | 3 | 2 | ✅ 通過 |
| `run_coater_diagnostics` | API | - | 2 | 2 | ✅ 通過 |
| `review_material_history` | API | - | 2 | 2 | ✅ 通過 |
| `create_corrective_action` | API | - | 3 | 2 | ✅ 通過 |
| `verify_coater_recovery` | API | - | 2 | 2 | ✅ 通過 |
