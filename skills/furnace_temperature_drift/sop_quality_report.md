...
| --- | --- | --- | --- | --- | --- |
| `confirm_temperature_drift_event` | API | - | 2 | 2 | ✅ 通過 |
| `place_furnace_on_hold` | API | - | 2 | 2 | ✅ 通過 |
| `identify_exposed_lots` | API | - | 3 | 2 | ✅ 通過 |
| `review_metrology_impact` | API | - | 2 | 2 | ✅ 通過 |
| `run_furnace_diagnostics` | API | - | 2 | 2 | ✅ 通過 |
| `create_corrective_action` | API | - | 3 | 2 | ✅ 通過 |
| `verify_furnace_recovery` | API | - | 2 | 2 | ✅ 通過 |
